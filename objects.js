...
//behind the scene of const keyword
//object has its own properties and we can change them
//like if we are doing writable false then we will not be able to change its value later and if we do enumerable false then we can;t iterate on that
const descripter = Object.getOwnPropertyDescriptor(Math, "PI");
console.log(descripter);
//we can define these properties for our own object also
const myuser = {
  name: "sneha",
  pssword: 3252,
  getName() {
